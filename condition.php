...
?>
    <form action="enterpayment.php" method="post">
    
    <div class="col-md-5 card" style="padding-bottom: 30px">
    <?php echo $address; ?>

    <label class="container">
        <input type="radio" name="radio" value= "1">ชำระ 1 เดือน
    </label>

    <label class="container">
        <input type="radio" name="radio" value= "6">ชำระ 6 เดือน
    </label>

    <label class="container">
        <input type="radio" name="radio"  value= "12">ชำระ 12 เดือน
    </label>

    <input type = "hidden" value = <?php echo $address ?> name = "address">
    <label class="container">
        <input type="submit" value="ถัดไป" name=""></a>
    </label>
