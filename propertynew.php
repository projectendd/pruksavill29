...
<html lang="en">
    	...
    	<div class="container">
    		<div class="row d-flex align-items-center">
    			...
    			<div class="col d-flex justify-content-end">
    				<p class="num"><span class="icon-phone"></span> BONUS999</p>
    			</div>
    		</div>
    	</div>
    </div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="property.html" class="nav-link">ชำระเงิน</a></li>
 ...
 <div style="padding-bottom: 110px; padding-left: 50px">
		<br>
	<div class="row">
		<div class="col-md-5">
...
<?php 
if(!isset($_GET['home'])) { ?>
	<p class="search" >ค้นหาบ้านเลขที่</p>
		<div class="search-container" >
			<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <form action="propertynew.php" method="GET" id="elem">
    <input type="text" name="home" id="home" placeholder="เลขที่บ้าน">
...
<?php }  else { ?>
	<p class="search" >ค้นหาบ้านเลขที่</p>
		<div class="search-container" >
			<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <form action="propertynew.php" method="GET" id="elem">
    <input type="text" name="home" id="home" placeholder="เลขที่บ้าน" value="<?php if($_GET['home'] == null || $_GET['home'] == "") {echo "";} else {echo  $_GET['home'];} ?>">
    <input type="submit" value="ค้นหา" id="submit"/>
    <script>
...
<?php 
	...
	$search_home = $_GET['home'];

	$sql = "SELECT * FROM tbl_home WHERE Address_home = '".$search_home."'";
	...
	if(!$chkResult){
		...
		<?php
		            ...
		            echo "<tr><td>ค่าใช้จ่ายส่วนกลาง   : ".$chkResult["Payment_home"]." บาท</td></tr>";
                    echo "<tr><td><input type=\"submit\" value=\"ชำระเงิน\"></td></tr>";
